...
if __name__ == "__main__":
    ...
    additional_notes = [
        {
            ...
            "content": "Прочитать новую книгу до конца месяца.",
            "status": "Новая",
        ...
        },
        {
            ...
            "content": "Повторить все темы по математике.",
            "status": "В процессе",
    ...
    # Сохранение начальных заметок в файл
    save_notes_to_file(initial_notes, filename)

    # Загрузка заметок из файла для проверки
    loaded_notes = load_notes_from_file(filename)
    print("Загруженные заметки после первого сохранения:")
    print(loaded_notes)

    # Добавление новых заметок в файл
    append_notes_to_file(additional_notes, filename)

    # Загрузка заметок из файла после добавления
    loaded_notes_after_append = load_notes_from_file(filename)
    print("Загруженные заметки после добавления новых заметок:")
    print(loaded_notes_after_append)